...
METRIC_CATALOG: list[dict[str, Any]] = [
    ...
    _metric(
        ...
        "Aplicar o CSV oficial de seis vertiportos tambem a aderencia e versionar a vigencia do cadastro.",
    ),
    _metric(
    ...
    _metric(
        ...
        "STATELOG, CSV UAM, SCN, REH, grupos e LoWC", "Em C2--C6 cruza os corredores do CSV oficial de seis vertiportos com os poligonos REH e publica waypoints 2D.",
        "Definir pesos do indice agregado e fornecer envelopes verticais oficiais para intersecao 3D.",
    ),
    _metric(
        "resource_throughput", "Throughput por recurso", "THR_r,dt=N_r,dt/|dt|",
        "Produto 3 v1, Eq. 4.24", "capacity.py::_resource_throughput",
        "Implementada em janelas de uma hora para OD, grupos, REH e cruzamentos", "implementada",
        "instancias, SCN, trajetorias e REH", "Calcula throughput por quatro familias de recurso com alvo clicavel no mapa.",
    ...
    _metric(
        ...
        "throughput e capacidade de referencia", "Mede proximidade ao envelope observado, inclusive P95 por waypoint UAM x REH.",
